...
class _EditState extends State<Edit> {
  ...
  void initState() {
    _firstNameCntrl = new TextEditingController(
      text: widget.formInputModel.firstName,
    );
    _lasttNameCntrl = new TextEditingController(
      text: widget.formInputModel.lastName,
    );
    _emailCntrl = new TextEditingController(
      text: widget.formInputModel.email,
    );
    _phoneCntrlCntrl = new TextEditingController(
      text: widget.formInputModel.phoneNumber,
    );

    _genderBLOC.selectGender(widget.formInputModel.gender!.toLowerCase());
    _employmentBLOC.setValue(widget.formInputModel.empStatus!);
    _educationQBLOC.setValue(widget.formInputModel.qualification!);
  ...
  void _delete() {
    widget.formInputInfoBLOC.deleteAndFeed(index);
    Pop(context);
  }
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      ...
      widget.formInputInfoBLOC.editAndFeed(
        model,
        index,
      );
